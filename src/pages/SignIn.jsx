    ...
    return (
        <div className="p-5 flex flex-col lg:flex-row items-center justify-center gap-10 container mx-auto min-h-screen"> 
            ...
            <form action="" className="w-full max-w-[550px] flex flex-col lg:ml-0">
                <h1 className="mb-5 text-4xl sm:text-5xl w-full">Sign In</h1>
                <p className='mb-10 text-sm sm:text-base'>
                    Dont have an account?
                    <Link to="/signup" className="text-blue-500 hover:underline underline-offset-2"> Sign up</Link>
                </p>
                ...
                <div className='flex justify-between items-center gap-2 w-full border rounded-md'>
                    <input
